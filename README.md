...
the PCB is for the wired version while the handwired version is the wireless one, you can just power the pcb via a tp4056 module and a battery and it will work fine :)
Why the PCB exists:
...
| 3D case and Keycaps | 6 | 0 | 0 | 0 | Self sourced |
| PCB estimate if needed | 1 | 2000 | 2000 | 21.18 USD | https://www.lioncircuits.com/ |
| Total |  |  | 1782 | 19.93531469 |  |

The total above matches the core handwired build. The PCB line is listed as an optional estimate.
